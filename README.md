...
### 🎓 **EduConnect Global** > **AI-powered university recommendation platform** - **Built responsive UI** with React and Tailwind CSS for student/university dashboards 
...
### 💡 Core Focus (Current Level: Frontend Developer)
- **XP Gained:** 6 months of intense coding
...
| **Next Up** | Three.js, WebGL, Advanced Animations |
...
### 🚀 Goals for 2025
- **Technical:** Master the React ecosystem + TypeScript.
- **Creative:** Build mind-blowing, cutting-edge portfolio pieces.
- **Community:** Win hackathons & actively mentor junior developers.
- **Personal:** Code every single day to maintain consistency.
